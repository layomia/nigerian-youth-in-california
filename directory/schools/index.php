...
<html >
  <head>
    ...
    <script type="text/javascript" src="../../jquery.scroll.events.js"></script>
  ...
  <body>
    ...
    <div id="directory">
      ...
      <div id="search-div">
        <input id="search-bar" type="text" placeholder="Search for schools">
      </div>


    <div class="contain">
      <div class="wrapper" id="school-profiles" style="margin-left:35px">
      </div>
    </div>
