...
function updateUserInfo (userInfo) {
  ...
  //if (mobileCheck() || isMobileSafari()) {
    document.getElementById('image').style.display = "none";
    document.getElementById('bio').style.marginLeft = "10px";
    document.getElementById('bio-box').style.width = "300px";
    document.getElementById('stats-box').style.width = "300px";
  //}
  //set image
  var imageID = "image";
  ...
  //set stats
  document.getElementById('school').innerHTML += userInfo.school;
  document.getElementById('major').innerHTML += userInfo.major;
  document.getElementById('email').innerHTML += userInfo.email;
  document.getElementById('tribe').innerHTML += userInfo.tribe;
}
